    ...
    <div className="row align-items-center">
      <div className="col-lg-4 col-sm-7">
        <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
          ...
          <h1>
            <b>Gabriela Ceballos</b>
            <span className="title-line-break">QA & UX/UI</span>
          </h1>
          <p>
            Innovating in testing through the implementation of new methodologies and technologies, while maintaining a constant focus on user-centered design, ensuring every product is functional, appealing, and user-friendly.
          </p>
          ...
          <div className="col-lg-5">
            <div className="author-image-part wow fadeIn delay-0-3s">
              ...
              <img src="assets/images/hero/me2.png" alt="Author" />
