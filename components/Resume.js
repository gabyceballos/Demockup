                ...
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-3s">
                    ...
                    <div className="content">
                      <span className="years">Jul. 2023 - Present</span>
                      <h4>QA Tester</h4>
                      <span className="company">Koibanx</span>
                      <p>QA Tester and Digital Strategist, design and implementation of Quality Tests.</p>
                    </div>
                  </div>
                </div>
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">Jul. 2016 - Present</span>
                      <h4>QA / UX Designer</h4>
                      <span className="company">WCS</span>
                      <p>Software and app tester, UX Designer. Experience with Selenium and JMeter.</p>
                    </div>
                  </div>
                </div>
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s">
                    ...
                    <div className="content">
                      <span className="years">Jun. 2020 - Apr. 2021</span>
                      <h4>Creative Designer</h4>
                      <span className="company">Freelance</span>
                      <p>Social media management, content design, and creation.</p>
                    </div>
                  </div>
                </div>
                <div className="col-xl-5 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-2s">
                    ...
                    <div className="content">
                      <span className="years">Aug. 2011 - Oct. 2013</span>
                      <h4>QA Tester</h4>
                      <span className="company"> Sistemas Webconsult Venezuela</span>
                      <p>Quality assurance and manual testing.</p>
                    </div>
                  </div>
                </div>
              </div>
